...
<body>
    <div
        class="hero min-h-[65vh] bg-no-repeat bg-cover bg-center
        ...
        <div class="hero-content text-center text-neutral-content">
            <div class="max-w-4xl">
                ...
                <p class="mb-5 text-2xl text-slate-300">
                    ...
                    Aynı şekilde, farklı sektörlerdeki iş ilanlarını keşfedebilir, başvurularınızı gönderebilir ve
                    kariyerinizi ilerletecek fırsatları yakalayabilirsiniz. Size özel profilinizi oluşturun ve iş
                    dünyasında adınızı duyurun.
